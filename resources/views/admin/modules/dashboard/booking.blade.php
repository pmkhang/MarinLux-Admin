...
@section('title', 'Admin - dashboard - list-booking')
@section('module', 'dashboard - list-booking')
...
@section('content')
    <div class="grid grid-cols-12 gap-6 mt-6">
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto">
                <div class="w-56 relative text-slate-500">
                    <input title="Search booking" id="search-booking" type="search"
        ...
        <div class="intro-y mt-5 col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
            ...
            <form id="paginate" action="{{ route('admin.dashboard.bookings') }}" method="GET">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#search-booking').on('keyup', debounce(function() {
